"""Ridge regression runtime estimator."""
...
class RidgeRegressionEstimator(SklearnEstimatorBase):
    """Runtime estimator using sklearn Ridge regression."""
    ...
    def _create_model(self) -> Any:
        ...
        return Ridge(alpha=self._alpha, random_state=self._random_state)
