...
def _build_parser() -> argparse.ArgumentParser:
    ...
    kernel.add_argument("--inference-weighted", action="store_true", help="Oversample inference-critical tasks and weight rewards")
...
def _cmd_train_kernel_grpo(args: argparse.Namespace) -> int:
    ...
    trainer = GRPOKernelTrainer(
        ...
        config=GRPOKernelConfig(
            ...
            inference_weighted=args.inference_weighted,
